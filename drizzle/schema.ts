...
export const organizations = mysqlTable(
  "organizations",
  {
    ...
    status: mysqlEnum("status", ["pending", "active", "suspended", "archived"])
      .default("pending")
      .notNull(),
    environment: mysqlEnum("environment", ["production", "showcase"])
      .default("production")
      .notNull(),
  ...
  table => ({
    nameIdx: index("organizations_name_idx").on(table.displayName),
    countryIdx: index("organizations_country_idx").on(table.countryCode),
  })
);
...
export const organizationMemberships = mysqlTable(
  "organization_memberships",
  {
    ...
    organizationRole: mysqlEnum("organizationRole", [
      "owner",
      "org_admin",
      "compliance_officer",
      "clinical_lead",
  ...
  table => ({
    membershipIdx: uniqueIndex("organization_memberships_unique_idx").on(
      table.organizationId,
      table.userId
    ),
    userIdx: index("organization_memberships_user_idx").on(
      table.userId,
      table.active
    ),
  })
...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "manager", "pharmacist", "cashier"])
    .default("user")
    .notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
...
export const branchUsers = mysqlTable(
  "branch_users",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    membershipIdx: uniqueIndex("branch_users_membership_idx").on(
      table.branchId,
      table.userId
    ),
  })
...
export const products = mysqlTable(
  "products",
  {
    ...
    officialPrice: decimal("officialPrice", {
      precision: 12,
      scale: 2,
    }).notNull(),
...
export const inventoryBatches = mysqlTable(
  "inventory_batches",
  {
    ...
    quantityOnHand: decimal("quantityOnHand", { precision: 14, scale: 3 })
      .default("0")
      .notNull(),
    reorderPoint: decimal("reorderPoint", { precision: 14, scale: 3 })
      .default("0")
      .notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    fefoIdx: index("inventory_batches_fefo_idx").on(
      table.branchId,
      table.productId,
      table.expiryDate
    ),
...
export const sales = mysqlTable(
  "sales",
  {
    ...
    discountAmount: decimal("discountAmount", { precision: 14, scale: 2 })
      .default("0")
      .notNull(),
    ...
    etaStatus: mysqlEnum("etaStatus", [
      ...
      .default("pending")
      .notNull(),
    saleStatus: mysqlEnum("saleStatus", ["completed", "voided", "cancelled"])
      .default("completed")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  },
  table => ({
    invoiceIdx: uniqueIndex("sales_invoice_idx").on(table.invoiceNumber),
    branchDateIdx: index("sales_branch_date_idx").on(
      table.branchId,
      table.createdAt
    ),
  })
...
export const promotions = mysqlTable(
  ...
  table => ({
    codeScopeIdx: uniqueIndex("promotions_scope_code_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.code
    ),
    activeIdx: index("promotions_active_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.status,
      table.startsAt,
...
export const salesReturns = mysqlTable(
  ...
  table => ({
    scopeIdx: index("sales_returns_scope_status_idx").on(
      table.organizationId,
      table.branchId,
      table.jurisdictionId,
      table.status
    ),
    saleIdx: index("sales_returns_sale_idx").on(table.originalSaleId),
  })
);
...
export const taxInvoices = mysqlTable(
  "tax_invoices",
  {
    ...
    status: mysqlEnum("status", [
      ...
      .default("draft")
      .notNull(),
    externalSubmissionGate: mysqlEnum("externalSubmissionGate", [
      "not_configured",
      "test_ready",
      "production_ready",
    ])
  ...
  table => ({
    numberScopeIdx: uniqueIndex("tax_invoices_scope_number_idx").on(
      table.organizationId,
      table.branchId,
      table.jurisdictionId,
      table.invoiceNumber
    ),
    scopeStatusIdx: index("tax_invoices_scope_status_idx").on(
      table.organizationId,
      table.branchId,
      table.jurisdictionId,
      table.status
    ),
    saleIdx: index("tax_invoices_sale_idx").on(table.saleId),
  })
);

export const taxInvoiceTemplates = mysqlTable(
  "tax_invoice_templates",
  {
    ...
    nameAr: varchar("nameAr", { length: 160 })
      .default("قالب الفاتورة الضريبية")
      .notNull(),
  ...
  table => ({
    scopeIdx: uniqueIndex("tax_invoice_templates_scope_idx").on(
      table.organizationId,
      table.branchId,
      table.jurisdictionId
    ),
    activeIdx: index("tax_invoice_templates_active_idx").on(
      table.organizationId,
      table.branchId,
      table.active
    ),
...
export const scheduledJobs = mysqlTable(
  ...
  table => ({
    taskUidIdx: uniqueIndex("scheduled_jobs_task_uid_idx").on(
...
export const branchAlerts = mysqlTable(
  "branch_alerts",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId"),
    ...
    status: mysqlEnum("status", ["queued", "sent", "read"])
      .default("queued")
      .notNull(),
  },
  table => ({
    dedupeIdx: uniqueIndex("branch_alerts_dedupe_idx").on(
      table.managerUserId,
      table.inventoryBatchId,
      table.alertType,
      table.alertDate
    ),
  })
...
export const notifications = mysqlTable(
  "notifications",
  {
    ...
    organizationId: int("organizationId"),
    branchId: int("branchId"),
    audienceRole: mysqlEnum("audienceRole", [
      "all",
      "admin",
      "manager",
      "pharmacist",
  ...
  table => ({
    scopeIdx: index("notifications_scope_idx").on(
      table.organizationId,
      table.branchId,
      table.active,
      table.createdAt
...
export const notificationReads = mysqlTable(
  ...
  table => ({
    readIdx: uniqueIndex("notification_reads_unique_idx").on(
      table.notificationId,
      table.userId
    ),
    userIdx: index("notification_reads_user_idx").on(
      table.userId,
      table.readAt
    ),
  })
...
export const ePrescriptions = mysqlTable(
  "e_prescriptions",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => ({
    codeIdx: uniqueIndex("e_prescriptions_scope_code_idx").on(
      table.organizationId,
      table.prescriptionCode
    ),
    patientIdx: index("e_prescriptions_patient_scope_idx").on(
      table.organizationId,
      table.branchId,
      table.patientId,
      table.status
    ),
    statusIdx: index("e_prescriptions_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.status
    ),
...
export const ePrescriptionLines = mysqlTable(
  "e_prescription_lines",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    status: mysqlEnum("status", [
      ...
      .default("ACTIVE")
      .notNull(),
    dispensedQuantity: decimal("dispensedQuantity", { precision: 12, scale: 3 })
      .default("0")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  ...
  table => ({
    prescriptionIdx: index("e_prescription_lines_prescription_idx").on(
      table.prescriptionId,
      table.status
    ),
    catalogIdx: index("e_prescription_lines_catalog_idx").on(
      table.catalogItemId
    ),
  })
);
...
export const callTickets = mysqlTable(
  "call_tickets",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    ...
    priority: mysqlEnum("priority", ["low", "normal", "high", "urgent"])
      .default("normal")
      .notNull(),
    status: mysqlEnum("status", ["open", "pending", "resolved", "closed"])
      .default("open")
      .notNull(),
  ...
  table => ({
    statusIdx: index("call_tickets_status_idx").on(
      table.status,
      table.priority
    ),
  })
...
export const catalogItems = mysqlTable(
  ...
  table => ({
    catalogSkuIdx: uniqueIndex("catalog_items_sku_idx").on(table.sku),
    catalogBarcodeIdx: index("catalog_items_barcode_idx").on(table.barcode),
  })
);

export const catalogSyncQueue = mysqlTable(
  "catalog_sync_queue",
  {
    id: int("id").autoincrement().primaryKey(),
    jurisdictionId: int("jurisdictionId"),
    ...
    status: mysqlEnum("status", ["pending", "synced", "conflict", "failed"])
      .default("pending")
      .notNull(),
    createdByUserId: int("createdByUserId").notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => ({
    idempotencyIdx: uniqueIndex("catalog_sync_idempotency_idx").on(
...
export const jurisdictionProfiles = mysqlTable(
  "jurisdiction_profiles",
  {
    id: int("id").autoincrement().primaryKey(),
    countryCode: varchar("countryCode", { length: 2 }).notNull(),
    countryNameAr: varchar("countryNameAr", { length: 120 }).notNull(),
    legalAuthorityProfile: varchar("legalAuthorityProfile", { length: 240 })
      .default("UNVERIFIED_AUTHORITY")
      .notNull(),
    ...
    numberSystem: varchar("numberSystem", { length: 16 })
      .default("latn")
      .notNull(),
  ...
  table => ({
    countryIdx: uniqueIndex("jurisdiction_profiles_country_idx").on(
      table.countryCode
    ),
  })
);

export const branchJurisdictions = mysqlTable(
  "branch_jurisdictions",
  {
    id: int("id").autoincrement().primaryKey(),
    branchId: int("branchId").notNull(),
    jurisdictionId: int("jurisdictionId").notNull(),
  ...
  table => ({
    branchIdx: uniqueIndex("branch_jurisdictions_branch_idx").on(
      table.branchId
    ),
  })
);

export const compliancePacks = mysqlTable(
  "compliance_packs",
  {
    id: int("id").autoincrement().primaryKey(),
    jurisdictionId: int("jurisdictionId").notNull(),
  ...
  table => ({
    versionIdx: uniqueIndex("compliance_packs_version_idx").on(
      table.jurisdictionId,
      table.packVersion
    ),
  })
...
export const complianceEvidence = mysqlTable(
  ...
  table => ({
    sourceIdx: index("compliance_evidence_source_idx").on(
      table.jurisdictionId,
      table.packId,
      table.operation
    ),
...
export const offlineDrafts = mysqlTable(
  "offline_drafts",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    payloadJson: text("payloadJson").notNull(),
    status: mysqlEnum("status", ["queued", "replayed", "conflict", "failed"])
      .default("queued")
      .notNull(),
  ...
  table => ({
    idempotencyIdx: uniqueIndex("offline_drafts_idempotency_idx").on(
      table.idempotencyKey
    ),
    ownerStatusIdx: index("offline_drafts_owner_status_idx").on(
...
export const reportDefinitions = mysqlTable(
  "report_definitions",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => ({
    scopeKeyIdx: uniqueIndex("report_definitions_scope_key_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.reportKey
    ),
    taskUidIdx: uniqueIndex("report_definitions_task_uid_idx").on(
      table.scheduleCronTaskUid
    ),
    statusIdx: index("report_definitions_status_idx").on(
      table.organizationId,
      table.status
    ),
  })
...
export const reportRuns = mysqlTable(
  "report_runs",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    idempotencyIdx: uniqueIndex("report_runs_idempotency_idx").on(
      table.idempotencyKey
    ),
    scopeTimeIdx: index("report_runs_scope_time_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.createdAt
    ),
...
export const reportDeliveryAttempts = mysqlTable(
  "report_delivery_attempts",
  {
    ...
    recipientUserId: int("recipientUserId"),
    channel: mysqlEnum("channel", ["in_app", "email", "sms", "webhook"])
      .default("in_app")
      .notNull(),
    status: mysqlEnum("status", ["queued", "delivered", "skipped", "failed"])
      .default("queued")
      .notNull(),
  ...
  table => ({
    scopeTimeIdx: index("report_delivery_scope_time_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.createdAt
    ),
...
export const insuranceRequests = mysqlTable(
  "insurance_requests",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    ...
    memberReferenceHash: varchar("memberReferenceHash", {
      length: 128,
    }).notNull(),
    ...
    credentialGate: mysqlEnum("credentialGate", [
      "NOT_CONFIGURED",
      "TEST_READY",
      "PRODUCTION_READY",
    ])
  ...
  table => ({
    idempotencyIdx: uniqueIndex("insurance_requests_idempotency_idx").on(
      table.idempotencyKey
    ),
    scopeStatusIdx: index("insurance_requests_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.status,
      table.updatedAt
...
export const internalCredentials = mysqlTable(
  "internal_credentials",
  {
    ...
    active: int("active").default(1).notNull(),
    accountType: mysqlEnum("accountType", ["employee", "showcase"])
      .default("employee")
      .notNull(),
  ...
  table => ({
    usernameIdx: uniqueIndex("internal_credentials_username_idx").on(
      table.username
    ),
    userIdx: uniqueIndex("internal_credentials_user_idx").on(table.userId),
  })
);

export const internalSessions = mysqlTable(
  "internal_sessions",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    sessionMode: mysqlEnum("sessionMode", ["production", "showcase"])
      .default("production")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => ({
    sessionHashIdx: uniqueIndex("internal_sessions_hash_idx").on(
      table.sessionHash
    ),
    userScopeIdx: index("internal_sessions_user_scope_idx").on(
      table.userId,
      table.organizationId,
      table.branchId,
      table.revokedAt
...
export const authenticationEvents = mysqlTable(
  ...
  table => ({
    authEventTimeIdx: index("authentication_events_time_idx").on(
      table.createdAt
    ),
    authEventScopeIdx: index("authentication_events_scope_idx").on(
      table.organizationId,
      table.branchId,
      table.jurisdictionId,
      table.createdAt
...
export const healthcareFacilities = mysqlTable(
  ...
  table => ({
    scopeIdx: index("healthcare_facilities_scope_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.facilityType
...
export const healthcarePatients = mysqlTable(
  "healthcare_patients",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    ...
    branchId: int("branchId").notNull(),
    nationalIdHash: varchar("nationalIdHash", { length: 128 }),
    localMedicalRecordNumber: varchar("localMedicalRecordNumber", {
      length: 80,
    }).notNull(),
    fullNameEncrypted: text("fullNameEncrypted").notNull(),
    dateOfBirthEncrypted: text("dateOfBirthEncrypted"),
    sex: mysqlEnum("sex", ["female", "male", "intersex", "unknown"])
      .default("unknown")
      .notNull(),
  ...
  table => ({
    mrnIdx: uniqueIndex("healthcare_patients_scope_mrn_idx").on(
      table.organizationId,
      table.branchId,
      table.localMedicalRecordNumber
    ),
    nationalIdx: index("healthcare_patients_national_hash_idx").on(
      table.organizationId,
      table.nationalIdHash
    ),
  })
);

export const healthcareEncounters = mysqlTable(
  "healthcare_encounters",
  {
    ...
    encounterType: mysqlEnum("encounterType", [
      "primary_care",
      "outpatient",
      "emergency",
      "inpatient",
  ...
  table => ({
    patientTimeIdx: index("healthcare_encounters_patient_time_idx").on(
      table.organizationId,
      table.branchId,
      table.patientId,
      table.createdAt
    ),
    statusIdx: index("healthcare_encounters_status_idx").on(
      table.organizationId,
      table.branchId,
      table.status
    ),
...
export const healthcareAppointments = mysqlTable(
  ...
  table => ({
    scheduleIdx: index("healthcare_appointments_schedule_idx").on(
      table.organizationId,
      table.branchId,
      table.scheduledAt,
      table.status
...
export const healthcareReferrals = mysqlTable(
  ...
  table => ({
    referralIdx: index("healthcare_referrals_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.fromBranchId,
      table.status
...
export const insuranceMembers = mysqlTable(
  "insurance_members",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => ({
    memberIdx: uniqueIndex("insurance_members_payer_member_idx").on(
      table.organizationId,
      table.payerCode,
      table.memberReferenceHash
    ),
    patientIdx: index("insurance_members_patient_idx").on(
      table.organizationId,
      table.patientId
    ),
  })
...
export const insuranceClaims = mysqlTable(
  ...
  table => ({
    claimIdx: uniqueIndex("insurance_claims_scope_number_idx").on(
      table.organizationId,
      table.claimNumber
    ),
    statusIdx: index("insurance_claims_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    idempotencyIdx: uniqueIndex("insurance_claims_idempotency_idx").on(
      table.idempotencyKey
    ),
  })
);
...
export const insuranceClaimLines = mysqlTable("insurance_claim_lines", {
  ...
  approvedAmount: decimal("approvedAmount", { precision: 14, scale: 2 }),
  adjudicationStatus: mysqlEnum("adjudicationStatus", [
    "pending",
    "approved",
    "partially_approved",
    "rejected",
...
export const healthcareBeds = mysqlTable(
  "healthcare_beds",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    ...
    branchId: int("branchId").notNull(),
    facilityId: int("facilityId").notNull(),
    wardCode: varchar("wardCode", { length: 80 }).notNull(),
    bedCode: varchar("bedCode", { length: 80 }).notNull(),
    status: mysqlEnum("status", [
      "available",
      "occupied",
      "reserved",
  ...
  table => ({
    scopeIdx: index("healthcare_beds_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    uniqueBed: uniqueIndex("healthcare_beds_facility_bed_idx").on(
      table.facilityId,
      table.bedCode
    ),
  })
...
export const healthcareAdmissions = mysqlTable(
  "healthcare_admissions",
  {
    ...
    branchId: int("branchId").notNull(),
    patientId: int("patientId").notNull(),
    encounterId: int("encounterId").notNull(),
    bedId: int("bedId"),
    admissionType: mysqlEnum("admissionType", [
      "planned",
      "emergency",
      "observation",
      "transfer",
    ...
    dischargeSummaryEncrypted: text("dischargeSummaryEncrypted"),
    createdByUserId: int("createdByUserId").notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    scopeIdx: index("healthcare_admissions_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    patientIdx: index("healthcare_admissions_patient_idx").on(
      table.organizationId,
      table.patientId
    ),
  })
...
export const healthcareClinicalOrders = mysqlTable(
  "healthcare_clinical_orders",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    jurisdictionId: int("jurisdictionId").notNull(),
    ...
    status: mysqlEnum("status", [
      ...
      .default("requested")
      .notNull(),
    resultEncrypted: text("resultEncrypted"),
    orderedByUserId: int("orderedByUserId").notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => ({
    scopeIdx: index("healthcare_orders_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    encounterIdx: index("healthcare_orders_encounter_idx").on(
      table.encounterId
    ),
  })
);

export const insurancePayerContracts = mysqlTable(
  "insurance_payer_contracts",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    jurisdictionId: int("jurisdictionId").notNull(),
    payerCode: varchar("payerCode", { length: 80 }).notNull(),
    contractReference: varchar("contractReference", { length: 120 }).notNull(),
    status: mysqlEnum("status", [
      "draft",
      "pending_review",
      "active",
  ...
  table => ({
    scopeIdx: index("insurance_payer_contracts_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.status
    ),
    refIdx: uniqueIndex("insurance_payer_contracts_ref_idx").on(
      table.organizationId,
...
export const insurancePreauthorizations = mysqlTable(
  "insurance_preauthorizations",
  {
    ...
    encounterId: int("encounterId"),
    payerCode: varchar("payerCode", { length: 80 }).notNull(),
    requestNumber: varchar("requestNumber", { length: 120 }).notNull(),
    status: mysqlEnum("status", [
      "draft",
      "ready",
      "submitted",
    ...
    credentialGate: mysqlEnum("credentialGate", [
      ...
      .default("not_configured")
      .notNull(),
    requestedAmount: decimal("requestedAmount", { precision: 14, scale: 2 })
      .default("0")
      .notNull(),
    approvedAmount: decimal("approvedAmount", { precision: 14, scale: 2 }),
    externalReference: varchar("externalReference", { length: 160 }),
  ...
  table => ({
    scopeIdx: index("insurance_preauth_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    requestIdx: uniqueIndex("insurance_preauth_request_idx").on(
      table.organizationId,
      table.requestNumber
    ),
    idemIdx: uniqueIndex("insurance_preauth_idempotency_idx").on(
      table.idempotencyKey
    ),
  })
);

export const insuranceRemittances = mysqlTable(
  "insurance_remittances",
  {
    ...
    branchId: int("branchId").notNull(),
    payerCode: varchar("payerCode", { length: 80 }).notNull(),
    remittanceReference: varchar("remittanceReference", {
      length: 120,
    }).notNull(),
    status: mysqlEnum("status", [
      "draft",
  ...
  table => ({
    scopeIdx: index("insurance_remittances_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    refIdx: uniqueIndex("insurance_remittances_ref_idx").on(
      table.organizationId,
      table.remittanceReference
    ),
  })
);

export const insuranceAppeals = mysqlTable(
  "insurance_appeals",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => ({
    scopeIdx: index("insurance_appeals_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    claimIdx: index("insurance_appeals_claim_idx").on(table.claimId),
  })
);

/** Internal private-hospital billing foundation; payer and tax submission remain fail-closed. */
export const hospitalBillingAccounts = mysqlTable(
  "hospital_billing_accounts",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    jurisdictionId: int("jurisdictionId").notNull(),
    ...
    depositAmount: decimal("depositAmount", { precision: 14, scale: 2 })
      .default("0")
      .notNull(),
    billedAmount: decimal("billedAmount", { precision: 14, scale: 2 })
      .default("0")
      .notNull(),
    paidAmount: decimal("paidAmount", { precision: 14, scale: 2 })
      .default("0")
      .notNull(),
    externalInvoiceGate: mysqlEnum("externalInvoiceGate", [
      "not_configured",
      "test_ready",
      "production_ready",
    ])
  ...
  table => ({
    scopeIdx: index("hospital_billing_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    patientIdx: index("hospital_billing_patient_idx").on(
      table.organizationId,
      table.patientId
    ),
  })
...
export const gaharReadinessProfiles = mysqlTable(
  "gahar_readiness_profiles",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    jurisdictionId: int("jurisdictionId").notNull(),
    ...
    status: mysqlEnum("status", [
      ...
      .default("draft")
      .notNull(),
    officialSubmissionGate: mysqlEnum("officialSubmissionGate", [
      "not_authorized",
      "test_ready",
  ...
  table => ({
    scopeIdx: index("gahar_profiles_scope_status_idx").on(
      table.organizationId,
      table.jurisdictionId,
      table.branchId,
      table.status
    ),
    facilityIdx: index("gahar_profiles_facility_idx").on(table.facilityId),
  })
);

export const gaharCriteria = mysqlTable(
  "gahar_criteria",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    profileStatusIdx: index("gahar_criteria_profile_status_idx").on(
      table.profileId,
      table.status
    ),
    codeIdx: uniqueIndex("gahar_criteria_profile_code_idx").on(
      table.profileId,
      table.criterionCode
    ),
  })
...
export const gaharEvidence = mysqlTable(
  "gahar_evidence",
  {
    id: int("id").autoincrement().primaryKey(),
    profileId: int("profileId").notNull(),
  ...
  table => ({
    criterionStatusIdx: index("gahar_evidence_criterion_status_idx").on(
      table.criterionId,
      table.verificationStatus
    ),
    profileIdx: index("gahar_evidence_profile_idx").on(table.profileId),
  })
);

export const gaharCorrectiveActions = mysqlTable(
  "gahar_corrective_actions",
  {
    id: int("id").autoincrement().primaryKey(),
    profileId: int("profileId").notNull(),
    criterionId: int("criterionId").notNull(),
  ...
  table => ({
    profileStatusIdx: index("gahar_actions_profile_status_idx").on(
      table.profileId,
      table.status
    ),
  })
...
export const gaharQualityIndicators = mysqlTable(
  "gahar_quality_indicators",
  {
    id: int("id").autoincrement().primaryKey(),
    profileId: int("profileId").notNull(),
    ...
    periodStart: timestamp("periodStart").notNull(),
    periodEnd: timestamp("periodEnd").notNull(),
    numerator: decimal("numerator", { precision: 14, scale: 4 })
      .default("0")
      .notNull(),
    denominator: decimal("denominator", { precision: 14, scale: 4 })
      .default("0")
      .notNull(),
  ...
  table => ({
    profilePeriodIdx: index("gahar_indicators_profile_period_idx").on(
      table.profileId,
      table.periodStart,
      table.periodEnd
    ),
    codeIdx: uniqueIndex("gahar_indicators_profile_code_period_idx").on(
      table.profileId,
      table.code,
      table.periodStart,
      table.periodEnd
