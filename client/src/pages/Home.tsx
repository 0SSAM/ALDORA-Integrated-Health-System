...
const organizationModules: Record<string, string[]> = { government: ["overview", "compliance", "finance", "people", "insurance", "egyptHealthcare", "icd10"], pharmacy: ["overview", "pos", "inventory", "supplyChain", "prescriptions", "insurance", "promotions", "compliance", "customerCare", "callCentre", "catalog", "icd10", "aiInsights", "antiFraud"], pharmacy_chain: ["overview", "pos", "inventory", "supplyChain", "prescriptions", "insurance", "promotions", "compliance", "finance", "people", "customerCare", "callCentre", "catalog", "icd10", "aiInsights", "antiFraud"], distributor: ["overview", "inventory", "supplyChain", "promotions", "compliance", "finance", "people", "catalog", "aiInsights", "antiFraud"], insurer: ["overview", "insurance", "compliance", "finance", "people", "customerCare", "icd10"], rehabilitation: ["overview", "prescriptions", "customerCare", "finance", "compliance", "people", "icd10"], hospital: ["overview", "inventory", "prescriptions", "insurance", "egyptHealthcare", "compliance", "finance", "people", "customerCare", "icd10", "antiFraud"], laboratory: ["overview", "prescriptions", "compliance", "finance", "people", "customerCare", "icd10"], radiology: ["overview", "prescriptions", "compliance", "finance", "people", "customerCare", "icd10"] };
...
function ModulePanel({ active, organizationId, branchId, jurisdictionId }: { active: string; organizationId: number | null; branchId: number | null; jurisdictionId: number | null }) {
  ...
  if (active === "people") return <div className="space-y-5"><OrganizationWorkspace organizationId={organizationId} /><OperationsManagementWorkspace organizationId={organizationId} branchId={branchId} jurisdictionId={jurisdictionId} /></div>;
