...
const showcaseTourSteps = [
  ...
  { module: "pos", title: "سيناريو بيع تدريبي: اعرض الضريبة والدفع", body: "اعرض الإجمالي وضريبة القيمة المضافة وطريقة الدفع ضمن الفاتورة النموذجية. لا تُسجل دفعة ولا تُنشأ مطالبة ولا يتغير أي رصيد." },
