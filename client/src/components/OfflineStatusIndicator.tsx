...
import { listDurableOfflineDrafts, type OfflineDraft } from "@/lib/offlineQueue";
...
export function OfflineStatusIndicator({ online, drafts, serverPendingCount = 0, onRefresh }: OfflineStatusIndicatorProps) {
